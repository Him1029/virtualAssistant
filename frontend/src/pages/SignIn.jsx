    ...
    style={{backgroundImage: `url(${bg})`}}>
        ...
        <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur
         shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
            ...
            bg-white rounded-full text-[20px] cursor-pointer' disabled={loading}>{loading?"Loading...":"Sign In"}</button>

            <p className='text-[white] text-[20px] cursor-pointer' onClick={()=>navigate("/signup")}>Want to create a new Account ? 
